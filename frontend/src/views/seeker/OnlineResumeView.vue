...
// Active nav section (for sidebar highlight)
const sections = [
...
<template>
  <div class="page-wrap">
    <div class="container">
      <h1 class="page-title fade-up">在线简历</h1>
      ...
      <div class="resume-layout">
        ...
        <div class="resume-content">
          ...
          <!-- ── 个人信息 ─────────────────────────── -->
          <section id="section-personal" class="rs-card">
          ...
          <!-- ── 个人优势 ─────────────────────────── -->
          <section id="section-bio" class="rs-card">
            <div class="rs-card__head">
          ...
          <!-- ── 期望职位 ─────────────────────────── -->
          <section id="section-desired" class="rs-card">
            <div class="rs-card__head">
              ...
              <div class="field field--full">
                ...
                <div class="skill-tags">
                  <span v-for="(p, i) in desired.positions" :key="p" class="tag tag--green skill-tag">
                    {{ p }}
                    <button type="button" class="skill-tag__remove" @click="removePos(i)">×</button>
                  </span>
                </div>
          ...
          <!-- ── 工作经历 ─────────────────────────── -->
          <section id="section-work" class="rs-card">
            <div class="rs-card__head">
          ...
          <!-- ── 项目经历 ─────────────────────────── -->
          <section id="section-project" class="rs-card">
            <div class="rs-card__head">
          ...
          <!-- ── 教育经历 ─────────────────────────── -->
          <section id="section-education" class="rs-card">
            <div class="rs-card__head">
          ...
          <!-- ── 专业技能 ─────────────────────────── -->
          <section id="section-skills" class="rs-card">
            <div class="rs-card__head">
